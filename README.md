...
To build the final jar and optimize the feedback360 application for production, run:
...
Then navigate to [http://localhost:29090](http://localhost:29090) in your browser.
