    ...
    <Row>
      <Col md="8">
        <h2 data-cy="questionDetailsHeading">
          <Translate contentKey="feedback360App.question.detail.title">Question</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="feedback360App.question.feedbackForm">Feedback Form</Translate>
          </dt>
          <dd>{questionEntity.feedbackForm ? questionEntity.feedbackForm.title : ''}</dd>
        </dl>
