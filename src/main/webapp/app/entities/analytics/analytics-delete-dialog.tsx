...
export const AnalyticsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="feedback360App.analytics.delete.question">
        <Translate contentKey="feedback360App.analytics.delete.question" interpolate={{ id: analyticsEntity.id }}>
