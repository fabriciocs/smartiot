...
export const AnalyticsUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...analyticsEntity,
          createdAt: convertDateTimeFromServer(analyticsEntity.createdAt),
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="feedback360App.analytics.home.createOrEditLabel" data-cy="AnalyticsCreateUpdateHeading">
            <Translate contentKey="feedback360App.analytics.home.createOrEditLabel">Create or edit a Analytics</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('feedback360App.analytics.type')}
                id="analytics-type"
                name="type"
                data-cy="type"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('feedback360App.analytics.data')}
                id="analytics-data"
                name="data"
                data-cy="data"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('feedback360App.analytics.createdAt')}
                id="analytics-createdAt"
                name="createdAt"
                data-cy="createdAt"
                type="datetime-local"
