...
import { sampleWithRequiredData } from '../meter.test-samples';
...
describe('Meter Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, MeterComponent],
      providers: [
        {
      ...
      .overrideTemplate(MeterComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to meterService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMeterIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getMeterIdentifier).toHaveBeenCalledWith(entity);
