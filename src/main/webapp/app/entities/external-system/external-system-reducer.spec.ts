...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXTERNALSYSTEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EXTERNALSYSTEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EXTERNALSYSTEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EXTERNALSYSTEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EXTERNALSYSTEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EXTERNALSYSTEM actions', async () => {
      const arg = 42666;
