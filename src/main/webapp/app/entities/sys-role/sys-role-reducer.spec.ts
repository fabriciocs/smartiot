...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sys-role.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SYSROLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SYSROLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SYSROLE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SYSROLE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SYSROLE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SYSROLE actions', async () => {
      const arg = 42666;
