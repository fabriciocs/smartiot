...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './feedback-response.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FEEDBACKRESPONSE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FEEDBACKRESPONSE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FEEDBACKRESPONSE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FEEDBACKRESPONSE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FEEDBACKRESPONSE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FEEDBACKRESPONSE actions', async () => {
      const arg = 42666;
