...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './integration-config.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTEGRATIONCONFIG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INTEGRATIONCONFIG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INTEGRATIONCONFIG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INTEGRATIONCONFIG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INTEGRATIONCONFIG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INTEGRATIONCONFIG actions', async () => {
      const arg = 42666;
