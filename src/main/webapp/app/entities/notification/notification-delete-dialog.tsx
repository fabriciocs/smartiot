...
export const NotificationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="feedback360App.notification.delete.question">
        <Translate contentKey="feedback360App.notification.delete.question" interpolate={{ id: notificationEntity.id }}>
