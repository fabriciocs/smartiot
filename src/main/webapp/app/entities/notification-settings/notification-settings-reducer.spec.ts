...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTIFICATIONSETTINGS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NOTIFICATIONSETTINGS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NOTIFICATIONSETTINGS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NOTIFICATIONSETTINGS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NOTIFICATIONSETTINGS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NOTIFICATIONSETTINGS actions', async () => {
      const arg = 42666;
