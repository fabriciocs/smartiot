...
export const NotificationSettingsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="feedback360App.notificationSettings.delete.question">
        <Translate contentKey="feedback360App.notificationSettings.delete.question" interpolate={{ id: notificationSettingsEntity.id }}>
