...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './audit-log.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches CREATE_AUDITLOG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AUDITLOG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AUDITLOG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AUDITLOG actions', async () => {
      const arg = 42666;
