...
import { sampleWithRequiredData } from '../sys-user.test-samples';
...
describe('SysUser Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, SysUserComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.sysUsers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
