...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sys-user.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SYSUSER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SYSUSER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SYSUSER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SYSUSER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SYSUSER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SYSUSER actions', async () => {
      const arg = 42666;
