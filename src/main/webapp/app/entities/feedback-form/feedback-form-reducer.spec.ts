...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FEEDBACKFORM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FEEDBACKFORM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FEEDBACKFORM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FEEDBACKFORM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FEEDBACKFORM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FEEDBACKFORM actions', async () => {
      const arg = 42666;
