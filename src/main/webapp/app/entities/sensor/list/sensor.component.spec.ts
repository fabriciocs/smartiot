...
import { sampleWithRequiredData } from '../sensor.test-samples';
...
describe('Sensor Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, SensorComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to sensorService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSensorIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSensorIdentifier).toHaveBeenCalledWith(entity);
