...
import { EntityArrayResponseType, SensorService } from '../service/sensor.service';
...
export class SensorComponent implements OnInit {
  ...
  trackId = (_index: number, item: ISensor): number => this.sensorService.getSensorIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.sensors = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ISensor[] | null): ISensor[] {
    return data ?? [];
  }
