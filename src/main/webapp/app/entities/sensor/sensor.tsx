  ...
  return (
    <div>
      <h2 id="sensor-heading" data-cy="SensorHeading">
        <Translate contentKey="feedback360App.sensor.home.title">Sensors</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="feedback360App.sensor.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/sensor/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="feedback360App.sensor.home.createLabel">Create new Sensor</Translate>
          </Link>
        </div>
      </h2>
        ...
        {sensorList && sensorList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="feedback360App.sensor.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th>
                  <Translate contentKey="feedback360App.sensor.cliente">Cliente</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="feedback360App.sensor.dadoSensores">Dado Sensores</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {sensorList.map((sensor, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{sensor.nome}</td>
                  <td>
                    <Translate contentKey={`feedback360App.TipoSensor.${sensor.tipo}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="feedback360App.sensor.home.notFound">No Sensors found</Translate>
            </div>
          )
        )}
      </div>
