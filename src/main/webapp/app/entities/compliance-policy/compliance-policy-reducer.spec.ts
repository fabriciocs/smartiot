...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './compliance-policy.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPLIANCEPOLICY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMPLIANCEPOLICY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMPLIANCEPOLICY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_COMPLIANCEPOLICY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_COMPLIANCEPOLICY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMPLIANCEPOLICY actions', async () => {
      const arg = 42666;
